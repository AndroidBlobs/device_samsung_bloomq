...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/vendor/etc/carrier/TFV/permissions/android.hardware.telephony.cdma.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/vendor/etc/carrier/TFV/permissions/android.hardware.telephony.cdma.xml \
...
# Inherit vendor
$(call inherit-product, vendor/samsung/bloomq/bloomq-vendor.mk)